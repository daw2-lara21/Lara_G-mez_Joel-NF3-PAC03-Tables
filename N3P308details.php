...
echo <<< ENDHTML
   ...
   <table cellpadding="2" cellspacing="2"
    ...
    <tr>
     <th style="width: 7em;"><a href="N3P308details.php?movie_id=$link $order='review_date'">Date</a></th>
